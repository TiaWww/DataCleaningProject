...
В проекте показаны 2 метода очистки данных:
- Метод межквартильного размаха
- Метод z-отклонений

Каждый из методов имеет свои достоинства и недостатки, не является универсальным, но вполне имеет право на существование.
